        ...
        {
            {
                ...
                //cout << mpos.x << " " << mpos.y << endl;
                                    ...
                                    //ImGui::Text("%.0fx%.0f", my_image_width, my_image_height);
              ...
              //  ImGui::BeginChild("", img_size);
                ...
                if (ImGui::IsMouseDown(ImGuiMouseButton_Left))
                {
                  ...
                  //  cout << endl;
                    //cout << mousePositionRelative.x << " " << mousePositionRelative.y << endl;
                    //cout << ImGui::IsMouseDown(ImGuiMouseButton_Left) << endl;
                }
